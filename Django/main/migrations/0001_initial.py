# Generated by Django 3.2.8 on 2021-11-14 21:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fight_type', models.CharField(choices=[('FC', 'Full Combat'), ('SP', 'Sportsman'), ('PL', 'Restricted Material'), ('NC', 'Non-Combat')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.weight_class')),
            ],
        ),
        migrations.CreateModel(
            name='Registration',
        ...
        migrations.AddField(
            ...
            name='members',
            field=models.ManyToManyField(through='main.Person_Franchise', to='main.Person'),
        ),
        migrations.CreateModel(
            name='Fight_Version',
            fields=[
                ...
                ('fight', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.fight')),
                ('version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.version')),
            ],
        ),
        migrations.AddField(
            model_name='fight',
            name='competitors',
            field=models.ManyToManyField(through='main.Fight_Version', to='main.Version'),
        ),
        migrations.AddField(
            model_name='fight',
            name='contest',
        ...
        migrations.AddField(
            model_name='event',
            name='franchise',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.franchise'),
        ),
        migrations.AddField(
            model_name='contest',
            name='event',
        ...
        migrations.AddField(
            model_name='contest',
            name='weight_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.weight_class'),
        ),
        migrations.CreateModel(
            name='Award',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('award_type', models.PositiveSmallIntegerField()),
                ('contest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.contest')),
                ('version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.version')),
            ],
        ),
