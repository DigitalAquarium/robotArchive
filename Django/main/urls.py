...
urlpatterns = [
    ...
    path('editor/fight/<int:fight_id>/details', views.fight_editj_view, name='edtFightDetails'),
    #path('editor/fight/<int:fight_id>/addRobot', views.modify_fight_version_view, name='edtFV'),
