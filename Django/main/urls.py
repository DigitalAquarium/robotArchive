...
urlpatterns = [
    ...
    path('robot/<int:robot_id>/transfer', views.robot_transfer_view, name='transferRobot_form'),
    path('robot/<int:robot_id>/transfer/<int:team_id>', views.robot_transfer_view, name='transferRobot'),
    path('robot/<int:robot_id>/edit', views.robot_edit_view, name='editRobot'),
    path('robot/new', views.new_robot_view, name='newRobot'),
    ...
    path('event/new/<int:franchise_id>', views.new_event_view, name='newEvent'),
    path('event/<int:event_id>/edit', views.modify_event_view, name='editEvent'),
    ...
    path('contest/<int:contest_id>/edit', views.edit_contest_view, name='editContest'),
    path('teams', views.team_index_view, name='teamIndex'),
    path('team/<slug:slug>', views.team_detail_view, name='teamDetail'),
    path('team/<int:team_id>/edit', views.team_edit_view, name='editTeam'),
    path('team/new', views.team_edit_view, name='newTeam'),
    path('franchises', views.franchise_index_view, name='franchiseIndex'),
    path('franchise/<int:franchise_id>/edit', views.franchise_modify_view, name='modifyFranchise'),
    path('franchise/new', views.franchise_modify_view, name='newFranchise'),
    path('franchise/<slug:slug>', views.franchise_detail_view, name='franchiseDetail'),
    path('fight/new/<int:contest_id>', views.new_fight_view, name='newFight'),
    path('fight/<int:fight_id>/edit', views.fight_edith_view, name='editWholeFight'),
    path('fight/<int:fight_id>', views.fight_detail_view, name='fightDetail'),
    path('fight/<int:fight_id>/modify', views.fight_editj_view, name='editJustFight'),
    path('fight/<int:fight_id>/addRobot', views.modify_fight_version_view, name='newFightVersion'),
    path('fight/<int:fight_id>/editRobot/<int:vf_id>', views.modify_fight_version_view, name='editFightVersion'),
    path('version/<int:version_id>', views.version_detail_view, name='versionDetail'),
    path('version/<int:version_id>/edit', views.version_edit_view, name='editVersion'),
    path('version/new/<int:robot_id>', views.new_version_view, name='newVersion'),
    path('event/<int:event_id>/awards', views.award_index_view, name='awardIndex'),
    path('award/new/<int:event_id>', views.new_award_view, name='newAward'),
    path('weight_class/new/<int:return_id>', views.new_weight_class_view, name='newWeightClass'),
    path('award/<int:award_id>/edit', views.award_edit_view, name='editAward'),
