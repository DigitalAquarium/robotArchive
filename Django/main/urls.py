...
urlpatterns = [
    ...
    path('contest/<int:contest_id>/signup', views.contest_signup_view, name='contestSignup'),
    path('contest/new/<int:event_id>', views.new_contest_view, name='newContest'),
    path('contest/edit/<int:contest_id>', views.edit_contest_view, name='editContest'),
